package com.drillmap.db;

import com.drillmap.db.repository.extensions.invoker.CustomRepositoryInvokerFactory;
import com.drillmap.db.security.TenantAwareUser;
...
public class Application {
    ...
    static class WebConfiguration {
        ...
        public CurieProvider curieProvider() {
            return new DefaultCurieProvider("db", new UriTemplate("http://localhost:9090/rels/{rel}"));
        }
    }
