package com.drillmap.db.repository.extensions.invoker;

import com.drillmap.db.repository.TenantAwareRepository;
...
public class CustomRepositoryInvokerFactory extends DefaultRepositoryInvokerFactory {
    ...
    private RepositoryInvoker prepareInvokers(Class<?> domainType) {
        ...
        if (repository instanceof TenantAwareRepository) {
            ...
            return new com.drillmap.db.repository.extensions.invoker.CrudRepositoryInvoker((CrudRepository<Object, Serializable>) repository, information,
                    conversionService);
        } else {
